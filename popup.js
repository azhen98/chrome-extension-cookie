...
async function handleGetCookie(name) {
  const key = document.getElementById('input-key').value || 'localtoken'
...
async function getCookie(name) {
  ...
  const cookie = await chrome.cookies.getAll({ name: name, domain: url.hostname });
